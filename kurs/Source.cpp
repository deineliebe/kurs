...
void first_task()
{
    ...
    std::cout << "First task: Write out v of memory (in bytes) on your computer for different types of data: int, short int, long int, float, double, long double, char è bool.\n";
...
void first_main()
{
    ...
    double double_num;
    number = 7;
    std::cout << "\n1) Write v of memory (in bytes) on your computer for different types of data: int, short int, long int, float, double, long double, char è bool.\n";
    ...
    try {
        while (number != 0)
        {
            ...
            case 2:
            {
                ...
                show_array(arr);
                std::cout << "\nÍà ñîðòèðîâêó óøëî " << std::fixed << t_cnt.count() << " ñåêóíä\n";
                break;
            }
            case 3:
            {
